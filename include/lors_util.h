...
int _lorsUnconditionData(LorsMapping *map, LorsConditionStruct *lc_array, char *cond_buf, char *uncond_buf, ulong_t src_offset, ulong_t l_len,ulong_t log_e2e_offset, ulong_t phy_length);
