...
int _lorsCreateDLListByBlockArray(LorsSet *set, longlong offset, longlong *block_array, int array_len, __LorsDLList *dl_list);
void _lorsKillWorkerThreads(__LorsThreadInfo *tinfo);

int _lorsDoCreate(__LorsJob *job, __LorsThreadInfo *tinfo);
int _lorsDoDownload(__LorsJob *job, __LorsThreadInfo *tinfo, LorsMapping *lm, int timeout);
int _lorsDoMCopyNE(__LorsJob *job, __LorsThreadInfo *tinfo);
int _lorsDoMCopyE2E(__LorsJob *job, __LorsThreadInfo *tinfo);
int _lorsDoCopyNE(__LorsJob *job, __LorsThreadInfo *tinfo);
int _lorsDoCopyE2E(__LorsJob *job, __LorsThreadInfo *tinfo);
