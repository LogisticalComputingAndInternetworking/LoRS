...
# 
#  DEPOT   pound.eecs.utk.edu  6714
#  DEPOT   ounce.eecs.utk.edu  6714

#
# The options below are used to manipulate LoDN proxy allocation.
# Currently, this feature is unimplemented and these options should not be set.
# If you attempt to enable it, the program will print an error and exit.
#

#
# Use ALLOCATE to specify what type of allocation you want. Currently, 0 means
# lors allocation and 1 means LoDN proxy allocation. If you use LoDN proxy 
# allocation, you must specify a username and password and lodn_url.
#
#ALLOCATE 0

#
# USERNAME specifies the username for LoDN proxy allocation
#
#USERNAME myusername

#
# PASSWORD specifies the password for a the given username in LoDN proxy 
# allocation
#
#PASSWORD mypassword

#
# LODN_URL specifies which LoDN server will perform the LoDN proxy allcation,
# if it is enabled
#
#LODN_URL mylodnserver
