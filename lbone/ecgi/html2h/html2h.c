...
void usage()
{
	printf(" html2h v0.1 usage: html2h input.html [output.h] if output is not set, input.h will be generated and overwritten! debug messages are written to stderr!");
	exit(0);
}
