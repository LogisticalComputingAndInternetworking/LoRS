		     ...
		     ExnodeMetadata *arguments)
{
    ...
    r = xor_DecryptMapping((unsigned char *)input_buffer, input_length,
		     ...
		     ExnodeMetadata *arguments)
{
    ...
    r = UncompressMapping((unsigned char *)input_buffer, input_length,
                          output_buffer, output_length);
		     ...
		     ExnodeMetadata *arguments)
{
    ...
    ret = aes_DecryptMapping((unsigned char *)input_buffer,input_length,blocksize,
